...
# Part III: PLAY A GAME FOR BLACK. Program: MiniMaxGame.py
# It gets user input for input file name, output file name, and depth for the game
# It uses Minimax algorithm to compute the best possible midgame-endgame move for the Maximizer (Black)
...
if __name__ == '__main__':
    ...
    for position in input_positions:
        result = MINIMAX.minimax_black('B', int(input_list[2]), position, game_phase, 0)
        print('INPUT:')
