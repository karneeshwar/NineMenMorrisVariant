...
# Part IV: STATIC ESTIMATION. Program: MiniMaxGameImproved.py
# It gets user input for input file name, output file name, and depth for the game
# It uses Minimax algorithm with improved static estimation to compute the best possible midgame-endgame move for the Maximizer (White)
...
if __name__ == '__main__':
    ...
    for position in input_positions:
        result = MINIMAX.minimax_improved('W', int(input_list[2]), position, game_phase, 0)
        print('INPUT:')
