...
# Part III: PLAY A GAME FOR BLACK. Program: MiniMaxOpeningBlack.py
# It gets user input for input file name, output file name, and depth for the game
# It uses Minimax algorithm to compute the best possible opening move for the Maximizer (Black)
