...
# Part IV: STATIC ESTIMATION. Program: MiniMaxOpeningImproved.py
# It gets user input for input file name, output file name, and depth for the game
# It uses Minimax algorithm with improved static estimation to compute the best possible opening move for the Maximizer (White)
