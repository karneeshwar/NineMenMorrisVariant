...
# Extra: ALPHA-BETA. Program: ABOpeningImproved.py
# It gets user input for input file name, output file name, and depth for the game
# It uses AlphaBeta pruning algorithm with improved static estimation to compute the best possible opening move for the Maximizer (White)
